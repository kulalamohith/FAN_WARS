  ...
  },
  {
    ...
    icon: (active: boolean) => (
      <div className="relative">
        ...
        <span className="absolute -top-1 -right-1.5 w-2 h-2 rounded-full bg-wz-red animate-pulse shadow-[0_0_6px_rgba(255,45,85,0.8)]" />
      </div>
    ),
  },
  {
...
const HIDDEN_ON = ['/login', '/war-room', '/bunkers', '/join', '/admin'];
